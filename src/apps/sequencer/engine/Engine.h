...
public:
    typedef Container<NoteTrackEngine, CurveTrackEngine, MidiCvTrackEngine, StochasticEngine, LogicTrackEngine, ArpTrackEngine, QuantizerTrackEngine> TrackEngineContainer;
